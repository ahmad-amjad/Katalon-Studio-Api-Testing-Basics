...
ResponseObject response = WS.sendRequest(findTestObject('Create Post', [('NewPostTitle') : newPostTitle, ('NewPostContent') : newPostContent
            , ('UserId') : userId]))
...
WS.verifyResponseStatusCode(response, 410, FailureHandling.STOP_ON_FAILURE)
